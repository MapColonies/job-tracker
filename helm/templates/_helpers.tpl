...
*/}}
{{- define "job-tracker.environment" -}}
...
*/}}
{{- define "job-tracker.cloudProviderFlavor" -}}
...
*/}}
{{- define "job-tracker.cloudProviderDockerRegistryUrl" -}}
...
*/}}
{{- define "job-tracker.cloudProviderImagePullSecretName" -}}
...
*/}}
{{- define "job-tracker.opentelemetryLoggingUrl" -}}
...
Usage: {{ include "job-tracker.otelResourceAttributes" .resourceAttributes }}
*/}}
{{- define "job-tracker.otelResourceAttributes" -}}
{{- $attributes := list }}
{{- range $key, $value := . }}
